...
function Navbar() {
  ...
  return (
    <div className="lg:h-20 h-16 flex items-center justify-between shadow-[#1026490F]/10 shadow-md bg-[#FFFFFF] w-screen">
      ...
      {isOpen && (
        <div
          className="lg:hidden absolute top-16 right-4 bg-white rounded-md shadow-md py-5"
          style={{ zIndex: 50 }}
        >
          <div className="text-lg font-semibold text-[#0F1629] px-4 py-2">
            <div className="cursor-pointer mb-2 border">Crypto Taxes</div>
            <div className="cursor-pointer mb-2">Free Tools</div>
            <div className="cursor-pointer mb-2">Resource Center</div>
            <div className="mt-4">
              <button className="bg-gradient-to-r from-[#2870EA] to-[#1B4AEF] px-8 py-2 text-white rounded-lg w-full">
                Get Started
              </button>
            </div>
          </div>
